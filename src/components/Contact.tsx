...
const Contact = () => {
  ...
  const [captchaAvailable, setCaptchaAvailable] = React.useState(true);
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (captchaAvailable && !captchaValue) {
  ...
  const handleCaptchaError = () => {
    ...
    setError(
      language === "en"
        ? "reCAPTCHA could not load (possibly blocked by browser extension). You can still send the message."
        : "reCAPTCHA не може да се вчита (можеби е блокирана од екстензија). Сепак можете да ја испратите пораката.",
    );
  };
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 lg:gap-10 mt-16">
            ...
            <div className="inline-flex items-center gap-3 mb-5">
              ...
              <h3 className="text-lg font-bold text-secondary leading-tight">
                {language === "en"
                  ...
                  : "Програми за истражување и знаење"}
              </h3>
            </div>
            <p className="text-gray-600 mb-4 leading-relaxed">
              {language === "en"
            ...
            <div className="mt-auto pt-6">
              ...
              >
                {language === "en"
                  ...
                  : "Поддржете ги истражувачките програми"}{" "}
                <ArrowRight className="ml-2 h-5 w-5" />
              </a>
            </div>
          </div>
          ...
          <div className="bg-white/90 backdrop-blur-sm p-8 sm:p-10 rounded-2xl shadow-lg hover:shadow-2xl transition-all flex flex-col min-h-[420px] hover:-translate-y-1">
            <div className="inline-flex items-center gap-3 mb-5">
              ...
              <h3 className="text-lg font-bold text-secondary leading-tight">
                {language === "en"
                  ? "Endowment & Long-Term Support"
                  : "Endowment и долгорочна поддршка"}
              </h3>
            </div>
            <p className="text-gray-600 mb-4 leading-relaxed">
              {language === "en"
            ...
            <div className="mt-auto pt-6">
              ...
              >
                {language === "en"
                  ? "Learn About Endowment"
                  : "Дознајте повеќе за Endowment"}{" "}
                <ArrowRight className="ml-2 h-5 w-5" />
              </a>
            </div>
          </div>
          ...
          <div className="bg-white/90 backdrop-blur-sm p-8 sm:p-10 rounded-2xl shadow-lg hover:shadow-2xl transition-all flex flex-col min-h-[420px] hover:-translate-y-1">
            <div className="inline-flex items-center gap-3 mb-5">
              ...
              <h3 className="text-lg font-bold text-secondary leading-tight">
                {language === "en"
                  ? "Impact-Oriented Funding"
                  : "Финансирање насочено кон влијание"}
              </h3>
            </div>
            <p className="text-gray-600 mb-4 leading-relaxed">
              {language === "en"
            ...
            <div className="mt-auto pt-6">
              ...
              >
                {language === "en"
                  ? "Discover Impact Models"
                  : "Откријте ги моделите за влијание"}{" "}
                <ArrowRight className="ml-2 h-5 w-5" />
              </a>
            </div>
          </div>
