              ...
              <div className="bg-white rounded-xl shadow-lg p-8 md:p-12 h-full">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold text-primary font-playfair">
                    {language === "en"
                      ? "Vladimir Grujeski Research Project"
                      : "Истражувачки проект на Владимир Грујески"}
                  </h2>
                </div>
              ...
              <div className="p-8 md:p-12 flex flex-col justify-center">
                <div className="mb-6">
                  ...
                  <p className="text-secondary font-medium">
                    {language === "en"
                      ? "Master's in International Relations & European Studies"
                      : "Магистер по меѓународни односи и европски студии"}
                  </p>
                  <p className="text-gray-600 text-sm">
                    {language === "en"
                      ? "University of Florence"
                      : "Универзитет во Фиренца"}
                  </p>
                </div>
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-gray-600 text-sm">
                      {language === "en"
                        ? "Research Focus: Italy's foreign policy toward Macedonia (1890-1919)"
                        : "Истражувачки фокус: Италијанската надворешна политика кон Македонија (1890-1919)"}
                    </p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-secondary rounded-full mt-2"></div>
                    <p className="text-gray-600 text-sm">
                      {language === "en"
                        ? "Archival research across Italy, Portugal, and Hungary"
                        : "Архивски истражувања низ Италија, Португалија и Унгарија"}
                    </p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-secondary rounded-full mt-2"></div>
                    <p className="text-gray-600 text-sm">
                      {language === "en"
                        ? "Contributing to European diplomatic history"
                        : "Придонес во европската дипломатска историја"}
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-6">
              <div className="border-l-2 border-secondary/30 pl-4">
                <p className="text-gray-700 text-sm font-medium mb-1">
                  TOMEČKOVÁ, Barbora.{" "}
                  <em>
                    Macedonian Language and Its Ausbau and Abstand Dimension
                ...
                >
                  ...
                  {language === "en" ? "Available at" : "Достапно на"}:
                  journals.ukim.mk
                </a>
              </div>
              ...
              <div className="border-l-2 border-secondary/30 pl-4">
                <p className="text-gray-700 text-sm font-medium mb-1">
                  TOMEČKOVÁ, Barbora.{" "}
                  <em>
                    Linguistic Relativism: The Limits of Language in Relation to
                    Non-binary and Intersex People in the Jurisprudence of the
                    Austrian and Czech Constitutional Courts.
                  </em>
                </p>
                <p className="text-gray-500 text-sm mb-2">
                  {language === "en"
              ...
              <div className="border-l-2 border-secondary/30 pl-4">
                <p className="text-gray-700 text-sm font-medium mb-1">
                  TOMEČKOVÁ, Barbora.{" "}
                  <em>
                    European States and Status of State Languages De Jure and De
                    Facto.
                  </em>
                </p>
                <p className="text-gray-500 text-sm mb-2">
              ...
              <div className="border-l-2 border-secondary/30 pl-4">
                <p className="text-gray-700 text-sm font-medium mb-1">
                  TOMEČKOVÁ, Barbora.{" "}
                  <em>
                    Review of: Official Language Designation:
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <span className="text-sm">
                    Austrian Association for Legal Linguistics
                  </span>
                </a>
              </div>
            </div>
