...
const translations = {
  en: {
    ...
    'samuel.focus': 'Cultural diplomacy, peace and development, EU enlargement, transatlantic relations, and promotion of equality through global initiatives.',
  ...
  mk: {
    ...
    'samuel.focus': 'Културна дипломатија, мир и развој, проширување на ЕУ, трансатлантски односи и промоција на еднаквост преку глобални иницијативи.',
