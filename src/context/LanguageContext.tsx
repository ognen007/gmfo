...
const translations = {
  en: {
    ...
    'manager.description': 'The Executive Manager will play a pivotal role in executing the foundation\'s mission, overseeing daily operations, and ensuring we deliver on our promises to the global Macedonian community.',
  ...
  mk: {
    ...
    'manager.description': 'Извршниот менаџер ќе има клучна улога во извршувањето на мисијата на фондацијата, надгледувањето на секојдневното работење и обезбедувањето на исполнувањето на нашите ветувања кон глобалната македонска заедница.',
