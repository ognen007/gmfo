...
const translations = {
  en: {
    ...
    'kostov.description': 'He holds degrees in ethnocoreology from the University "Goce Delčev" and Ss. Cyril and Methodius University works as a scientific associate at the Institute of Folklore in Skopje.',
